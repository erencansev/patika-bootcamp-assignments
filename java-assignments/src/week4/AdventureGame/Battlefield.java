...
public class Battlefield extends Location {
        ...
        Battlefield(Player player, String name, Obstacle obstacle, String award) {
            super(player);
        ...
        public boolean getLocation() {
            ...
            System.out.println("Konumun : " + this.getName());
                ...
                while (player.getHealthy() > 0 && obstacle.getHealth() > 0) {
                    ...
                    if (selCase.equals("V")) {
                        ...
                        if (obstacle.getHealth() > 0) {
                            System.out.println();
                            System.out.println("Canavar size hasar verdi !");
